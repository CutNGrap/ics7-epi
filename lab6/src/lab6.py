...
def graphs(): 
    ...
    for sced in sced_values:
        ...
        pyplot.plot(['очень низкий', 'низкий', 'номинальный', 'высокий', 'очень высокий'], rely_result[0], label='RELY')
        pyplot.plot(['низкий', 'номинальный', 'высокий', 'очень высокий'], data_result[0], label='DATA')
        pyplot.plot(['очень низкий', 'низкий', 'номинальный', 'высокий', 'очень высокий'], cplx_result[0], label='CPLX')
        pyplot.ylabel("PM")
        pyplot.legend()

        pyplot.subplot(122)
        pyplot.title("Время (SCED = " + str(sced) + ")")
        pyplot.plot(['очень низкий', 'низкий', 'номинальный', 'высокий', 'очень высокий'], rely_result[1], label='RELY')
        pyplot.plot(['низкий', 'номинальный', 'высокий', 'очень высокий'], data_result[1], label='DATA')
        pyplot.plot(['очень низкий', 'низкий', 'номинальный', 'высокий', 'очень высокий'], cplx_result[1], label='CPLX')
        pyplot.ylabel("TM")
        pyplot.legend()
        pyplot.show()
